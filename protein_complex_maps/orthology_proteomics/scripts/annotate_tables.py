...
def make_labels(annotation, profile, outfile, join_on, sep1, sep2, suffix, target_col):
...
make_labels(inputs.annotation_file, inputs.target_profile, inputs.outfile, inputs.join_on, inputs.sep1, inputs.sep2, inputs.suffix, inputs.target_col)
