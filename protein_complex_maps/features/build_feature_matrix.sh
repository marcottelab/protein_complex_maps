...
python   /project/cmcwhite/protein_complex_maps/protein_complex_maps/features/build_feature_matrix.py --input_pairs_files $FEATURE_STR --output_file ${EXP_ID}_feature_matrix.txt --prev_feature_matrix $EXISTING_MATRIX 
