...
cat $ELUTION_FILE | parallel -j4 python ../../features/convert_correlation.py --input_correlation_matrix {}.corr_${CORR} --input_elution_profile {}.csv --output_file {}.corr_${CORR}.pairs --sep ','
