...
for f in n*plants_euNOG_concat.csv 
do 
    python ../../complex_comparison.py --cluster_predictions $f --gold_standard ../corum/nonredundant_allComplexesCore_mammals_euNOG_merged06.train.txt --remove_non_gold_standard_proteins --normalize_by_combinations --pseudocount 0.00001
done
