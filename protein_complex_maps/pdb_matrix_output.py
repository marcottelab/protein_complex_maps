...
def main():
	...
	pdb_plot_data = dict()
        ...
        for pdbid in pdb_list:
                a1_list, a2_list =  pdb_calc_interactions(msds, pdbid, args.base_species, args.pisa_dir)
                if a1_list != None and a2_list != None:
                        pdb_plot_data[pdbid] = (a1_list, a2_list)


def pdb_chain_map(pdbid, base_species):


def pdb_calc_interactions(msds, pdbid, base_species, pisa_dir ):
	print pdbid
